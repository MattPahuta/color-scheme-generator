...
// Copy hex values - click or keyboard
function copyHex(e) {
...
function init() {
  ...
  colorBars.addEventListener('click', copyHex);
  colorBars.addEventListener('keypress', copyHex);
  
  colorForm.reset(); // reset form on page load
  getColors(); // get default colors results
}
